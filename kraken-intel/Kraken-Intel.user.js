...
(function () {
    ...
    function currentTargetId() {
        ...
        if (url.pathname !== "/page.php" || url.searchParams.get("sid") !== "attack") return null;
        return positiveInteger(url.searchParams.get("user2ID"));
    }
    ...
    function renderPanel() {
        ...
        note.textContent = "Saved locally only — nothing has been uploaded or shared.";
    ...
    function installStyles() {
        ...
        style.textContent = `
            ...
            #kraken-intel-panel .ki-row{display:grid;grid-template-columns:78px minmax(0,1fr);gap:8px;padding:7px 10px;border-top:1px solid #ffffff12}
    ...
    function mountPanel() {
        ...
        version.textContent = `Local test v${VERSION}`;
